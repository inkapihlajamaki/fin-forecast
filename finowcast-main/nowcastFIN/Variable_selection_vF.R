...
target <- "GDP"            # name of the target variable (line 4 in input Excel)
start_date <- "2015-03-31" # start date for the pre-selection. 
                           # NB: only quarters starting after this date will be retained
end_date <- "2025-12-31"   # end date for the pre-selection
